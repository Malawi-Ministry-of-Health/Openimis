...
const [invoiceNote, setInvoiceNote] = useState(invoice?.note);
const [invoicePaymentReference, setInvoicePaymentReference] = useState(invoice?.paymentReference);
...
useEffect(() => {
  ...
  invoicePaymentReference={invoicePaymentReference}
  setInvoicePaymentReference={setInvoicePaymentReference}
