...
const InvoiceHeadPanel = ({ modulesManager, classes, invoice, mandatoryFieldsEmpty, onChange, invoiceStatus, setInvoiceStatus, invoiceNote, setInvoiceNote, invoicePaymentReference, setInvoicePaymentReference }) => {
